...
export const getImgSrc = (index: number | undefined) => {
  if(!index) return  'https://user-images.githubusercontent.com/47528556/107217786-080f1200-6a52-11eb-93a4-dc65a2496cf0.png'
